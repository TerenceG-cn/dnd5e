...
public interface SkillBonusesDao {
    @Insert("INSERT INTO skillbonuses(monsterId,athletics,acrobatics,sleightOfHand,stealth,arcana,history,religion,nature,investigation,insight,perception,animalHanding,medicine,survival,deception,persuation,intimidation,performance" +
